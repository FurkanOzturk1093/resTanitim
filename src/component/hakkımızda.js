  ...
  return (
    <div>
      ...
      <p className=" text-center text-xl leading-normal  ">
        <span className=" text-orange-300 ">RES Mühendislik</span> ,
        Cumhuriyetimizin bize gösterdiği ışık ve verdiği düşünce özgürlüğü,
        yurdumuzun güzelliklerinden aldığımız özgüven ve güçle yola çıktığımız
        ticaret hayatında, grup olarak önemli bir noktaya geldik. Ancak bu
        nokta, daima ilerletmemiz, daha uzağa taşımamız gereken, gelecek
        nesillere devredeceğimiz yeni bir atlama noktası olarak, bizlere daha
        fazla sorumluluk yüklemektedir. Geçmişte görevini yerine getirenlerin
        bizlere bu ateşi bıraktığı gibi, biz de zirve dediğimiz yerde, bu ateşi
        gelecek nesillerin sinelerine işleyeceğiz. Onlar daha mükemmelini
        yapacaklar. <br />
        <span className=" text-orange-300 ">RES Mühendislik</span> firması
        olarak daima kalite hedefiyle yola çıkmakta, müşteri memnuniyetini her
